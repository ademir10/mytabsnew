...
import { Button, KeyboardAvoidingView, Dimensions, FlatList, Modal, Pressable, ActivityIndicator, Image, View, Text, StyleSheet, TextInput, TouchableOpacity, Alert, ScrollView } from "react-native";
...
export default function Setlist() {
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            var url = config.address_api + '/pages/index_setlist';
            const request = fetch(url, {
                method: 'POST',
                body: JSON.stringify({
                    app: 'Sim',
                    info_user: dadosSessao.user_settings,
                }),
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                },
    ...
    async function show_especial_tabs() {
        var infoData = await AsyncStorage.getItem('@storageMytabs:dados_session')
        let dadosSessao = JSON.parse(infoData);
        ...
        const request = fetch(url, {
            ...
            body: JSON.stringify({
                app: 'Sim',
                info_user: dadosSessao,
                show_especial_tabs: 'Sim'
            }),
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
            },
    ...
    const handleSubmit = (data) => {
        ...
        if (validNomeMusica === '#ff7401'
            || validVersao === '#ff7401'
            || validTomOriginal === '#ff7401'
            || validTom === '#ff7401'
            || validRevisado === '#ff7401'
            || validLinkYoutube === '#ff7401'
            || validLetra === '#ff7401'
        ) {
    ...
    const checkAtivoCulto = (data) => {
        ...
        const fetchData = async () => {
            ...
            var url = config.address_api + '/pages/crud_setlist';
            const request = fetch(url, {
                method: 'POST',
                body: dados,
                headers: {
    ...
    async function set_ordem_exibicao_app(data) {
        var numero = await data.numero.nativeEvent.text;
        ...
        const fetchData = async () => {
            ...
            var url = config.address_api + '/pages/set_ordem_exibicao_app';
            const request = fetch(url, {
                method: 'POST',
                body: dados,
                headers: {
                ...
                .then(
                    (retorno_API) => {
                        ...
                        if (retorno_API.erro == 'sim') {
                            ...
                            setTablaturas(retorno_API.tablaturas);
                        }
                    }, (error) => {
                        setIsLoading(false);
                        Alert.alert('Aviso:', 'Não conseguimos acessar o datacenter, verifique sua conexão com a internet e se persistir avise o nosso suporte.', [{ text: 'OK', onPress: () => fecharModal() },]);
    ...
    async function playAudio(data) {
        ...
        try {
            ...
            Alert.alert(`Ops.. não conseguimos encontrar o audio: `, e);
        }
    }
                ...
                {tablaturas ? (
                    <View>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={styles.textMenu}>Musicas prontas</Text>
                        </View>
                        <TextInput
                            value={searchQuery}
                            autoCapitalize="none"
                        ...
                        <View style={{ position: 'absolute', right: 40 }}>
                            ...
                            >
                                <Image source={require('../../assets/buttons/btn-especial-tabs.png')} style={{
                                            ...
                                            <View>
                                                <View style={{ paddingVertical: 5 }}>
                                                    <View style={{ flexDirection: 'row' }}>
                                                        ...
                                                        <View style={{ flex: 0.3 }}>
                                                            <View style={{ position: 'absolute', right: 59, paddingTop: 5 }}>
                                                                <BouncyCheckbox
                                                            ...
                                                            <View style={{ position: 'absolute', right: 0, alignSelf: 'center', paddingTop: 4 }}>

                                                                <TextInput
                                                                    onEndEditing={(text) => set_ordem_exibicao_app({ numero: text, nome_musica: item.nome_musica })}
                                                                    maxLength={2}
                                                                    style={{
                                                                        borderRadius: 5,
                                                                        borderWidth: 1,
                ...
                <Modal
                    ...
                    <View style={styles.modalView}>
                        ...
                        <View style={{ flexDirection: 'row', padding: 10, alignSelf: 'center' }}>
                            <Text style={styles.textMenu}>{dadosTab.nome_musica} ( Tom: {dadosTab.tom} )</Text>
                        </View>

                        <View style={{ paddingVertical: 10 }}>
                            <View style={styles.labelContainerSlider}>
                                <Text style={{ color: 'grey', fontFamily: 'EncodeSans-Light' }}>Ajuste tamanho da fonte:</Text>
                            </View>
                            <View style={styles.inputContainer}>
                                ...
                                <View style={{ padding: 10, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ left: 10 }}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            <Image source={require('../../assets/buttons/btn-scroll.png')} style={{ width: 25, height: 25, resizeMode: 'contain' }} />
                                ...
                                <Slider
                                    style={{ width: '100%', height: 20, marginStart: -5 }}
                                    minimumValue={10} // Minimum font size
                                    maximumValue={30} // Maximum font size
                                    step={1} // Step size
                                    value={tamanhoFonte}
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} ref={scrollViewRef}>
                            ...
                            <Animated.View style={animatedStyle}>
                                ...
                                <Text style={{ fontFamily: 'EncodeSans-Light', paddingBottom: 5, flexShrink: 1, fontSize: 20 }}>
                                    <Markdown
                                        style={{
                                            body: { fontFamily: 'EncodeSans-Light', fontSize: tamanhoFonte, lineHeight: tamanhoFonte + 6 }
                                        }}
